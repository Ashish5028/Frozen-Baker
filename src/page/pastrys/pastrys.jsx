    ...
    <div className="bg-white  shadow-md rounded-md py-10 mx-6">
      ...
      <div className=" grid grid-cols-2 px-14  gap-6 pt-4">
        <Link to="/api/bestseller">
          <img src={Chocolates} className="rounded-lg h-[250px] w-[600px]" />
        </Link>
        <Link to="/api/dayseller">
          <img src={apple} className="rounded-lg h-[250px] w-[600px]" />
        </Link>
        <Link to="/api/midnight">
          <img src={eggless} className="rounded-lg h-[250px] w-[600px]" />
        </Link>
        <Link to="/api/brandnew">
          <img src={img} className="rounded-lg h-[250px] w-[600px]" />
        </Link>
      </div>
    </div>
  );
